...
function submitTask() {
  ...
  if (selectedTaskItem) {
    feedback.innerHTML = `<div style="padding:15px; margin-top:15px; border-radius:12px; background:rgba(34,197,94,0.2); color:#86efac; border-left:4px solid #22c55e;">
      <strong>✓</strong> Aufgabe erfolgreich gelöst!
    </div>`;
    document.getElementById("saveTaskBtn").style.display = "block";
  } else {
    feedback.innerHTML = `<div style="padding:15px; margin-top:15px; border-radius:12px; background:rgba(239,68,68,0.2); color:#fca5a5; border-left:4px solid #ef4444;">
      <strong>✗</strong> Bitte wähle die korrekte Aufgabe aus.
    </div>`;
  }
}
...
function submitTask2() {
  ...
  if (selectedTaskItem) {
    ...
    document.getElementById("saveTaskBtn2").style.display = "block";
  } else {
    feedback.innerHTML = `<div style="padding:15px; margin-top:15px; border-radius:12px; background:rgba(239,68,68,0.2); color:#fca5a5; border-left:4px solid #ef4444;">
      <strong>✗</strong> Bitte wähle die korrekte Aufgabe aus.
    </div>`;
...
function submitTask3() {
  ...
  if (selectedTaskItem) {
    ...
    document.getElementById("saveTaskBtn3").style.display = "block";
  } else {
    feedback.innerHTML = `<div style="padding:15px; margin-top:15px; border-radius:12px; background:rgba(239,68,68,0.2); color:#fca5a5; border-left:4px solid #ef4444;">
      <strong>✗</strong> Bitte wähle die korrekte Aufgabe aus.
    </div>`;
...
function submitTask4() {
  ...
  if (selectedTaskItem) {
    ...
    document.getElementById("saveTaskBtn4").style.display = "block";
  } else {
    feedback.innerHTML = `<div style="padding:15px; margin-top:15px; border-radius:12px; background:rgba(239,68,68,0.2); color:#fca5a5; border-left:4px solid #ef4444;">
      <strong>✗</strong> Bitte wähle die korrekte Aufgabe aus.
    </div>`;
